...
abstract contract ExhibitionBase is Ownable, ReentrancyGuard, ITokenCalculation {
    ...
    address public USDXTokenAddress;
    uint256 public platformFeePercentage;
    address public platformFeeRecipient;
    uint256 public faucetAmountEXH;
    uint256 public faucetAmountUSDX;
    uint256 public faucetCooldownBlocks;
    mapping(address => uint256) internal lastFaucetRequestBlock;
    ...
    mapping(uint256 => uint256) public successBlock;
    ...
    event LiquidityDeadlinePassed(uint256 indexed projectId, uint256 blockNumber);
