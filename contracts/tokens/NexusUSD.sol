...
/**
 * @title NexusUSD
 * @dev A mock ERC20 token contract to represent USDX on the Nexus testnet.
 ...
 */
contract NexusUSD is ERC20, Ownable {
    ...
    constructor(address initialOwner)
        ERC20("Nexus USD", "USDX")
        Ownable(initialOwner)
    {
        // Mint 1,000,000 USDX tokens to the deployer for testing.
