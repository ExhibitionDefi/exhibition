...
**Cliff** — The waiting period before interval vesting begins. A cliff signals that the project is building before distributing. Set it in blocks that reflect your actual development timeline.
