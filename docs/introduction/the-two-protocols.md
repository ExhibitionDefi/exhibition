...
Exhibition is a pure tool. The only protocol-enforced boundaries are the soft cap minimum of 51% of the funding goal, maximum launch duration and liquidity finalization deadline. Everything else is configured by the project and launches exactly as intended.
